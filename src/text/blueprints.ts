...
export const upgradeEffects: { [key: string]: [[string, string], [string, string]] } = {
    ...
    'health4': [['misc/health', '250 Health'], ['misc/health', '300 Health (+50)']],
    ...
    'power5': [['misc/energy', '275 Energy'], ['misc/energy', '300 Energy (+25)']],   
    ...
    'jetpack2': [['upgrades/jetpack', 'Jetpack'], ['upgrades/jetpack', '- Jetpack Energy Consumption']],
    ...
    'tankBooster5': [['upgrades/tankBooster', '60 Units Capacity'], ['upgrades/tankBooster', '70 Units Capacity (+10)']],
    'tankBooster6': [['upgrades/tankBooster', '70 Units Capacity'], ['upgrades/tankBooster', '80 Units Capacity (+10)']],
...
export const warpDescriptions: { [key: string]: string } = {
    ...
    'teleportgl': "A teleporter that hacks the warp network on Rainbow Island, allowing one-way travel to Grey Labyrinth.",
    ...
    'teleportgold': "A set of two teleporters that can be used to create your own quick travel link.",
...
export const decorationsList: { [key: string]: [string, string, { [key: string]: number }, string] } = {
    ...
    'tallpinkcoralcolumns': ['Tall Pink Coral Columns', 'thora', { 'newbucks': 150, 'angler': 10, 'wax': 3, 'primordy': 2, 'sand': 2 }, 'fields'],
    ...
    'starbloomflowers': ['Starbloom Flowers', 'pod', { 'newbucks': 25, 'flutter': 10, 'wax': 1 }, 'strand'],
    'azuregrass': ['Azure Grass', 'thora', { 'newbucks': 25, 'pink': 5, 'wax': 1 }, 'strand'],
    'azureshrubs': ['Azure Shrubs', 'ogden', { 'newbucks': 50, 'tabby': 10, 'brine': 1 }, 'strand'],
    'azuremangrove': ['Azure Mangrove', 'pod', { 'newbucks': 200, 'puddle': 10, 'primordy': 3, 'brine': 2, 'wildHoney': 2 }, 'strand'],
    'pinkgrass': ['Pink Grass', 'thora', { 'newbucks': 25, 'pink': 5, 'wax': 1 }, 'strand'],
    'pinkmangrove': ['Pink Mangrove', 'thora', { 'newbucks': 150, 'jelly': 3, 'wax': 2, 'wildHoney': 2 }, 'strand'],
    'roottangle': ['Root Tangle', 'pod', { 'newbucks': 100, 'ringtail': 20, 'wax': 3, 'primordy': 2, 'wildHoney': 2 }, 'strand'],
    'rootarches': ['Root Arches', 'mochi', { 'newbucks': 100, 'flutter': 20, 'wax': 3, 'primordy': 2, 'wildHoney': 2 }, 'strand'],
    'costalrock': ['Costal Rock', 'pod', { 'newbucks': 75, 'cotton': 10, 'jelly': 1 }, 'strand'],
    'costalrockpillar': ['Costal Rock Pillar', 'pod', { 'newbucks': 75, 'tabby': 10, 'brine': 1 }, 'strand'],
    'tallvioletswirlshroom': ['Tall Violet Swirl Shrool', 'pod', { 'newbucks': 100, 'honey': 10, 'brine': 3, 'wax': 2, 'wildHoney': 2 }, 'strand'],
    'violetswirlshroom': ['Violet Swirl Shroom', 'mochi', { 'newbucks': 100, 'hunter': 20, 'radiant': 3, 'brine': 2, 'wildHoney': 2 }, 'strand'],
    'azureglowshrooms': ['Azure Glow Shrooms', 'mochi', { 'newbucks': 100, 'phosphor': 10, 'brine': 3, 'wax': 2, 'diamond': 1 }, 'strand'],
    'pinkglowshrooms': ['Pink Glow Shrooms', 'mochi', { 'newbucks': 100, 'phosphor': 20, 'jelly': 3, 'lava': 2, 'diamond': 1 }, 'strand'],
    'cavepillar': ['Cave Pillar', 'pod', { 'newbucks': 75, 'pink': 10, 'brine': 1 }, 'strand'],
    'thincavepillar': ['Thin Cave Pillar', 'bob', { 'newbucks': 50, 'rock': 10, 'brine': 1 }, 'strand'],
    'mossyhenstatue': ['Mossy Hen Statue', 'pod', { 'newbucks': 2500, 'yolky': 15, 'brine': 5, 'fossil': 5, 'wildHoney': 2 }, 'strand'],
    'cheerfulstatue': ['Cheerful Statue', 'pod', { 'newbucks': 700, 'ringtail': 20, 'fire': 10, 'tabby': 15, 'radiant': 10, 'wax': 10 }, 'strand'],
    'rubygrass': ['Ruby Grass', 'thora', { 'newbucks': 25, 'pink': 5, 'brine': 1 }, 'bluffs'],
    'snowybush': ['Snowy Bush', 'pod', { 'newbucks': 100, 'batty': 10, 'snowflake': 1 }, 'bluffs'],
    'icetreeo': ['Ice Treeo', 'pod', { 'newbucks': 250, 'crystal': 15, 'snowflake': 2 }, 'bluffs'],
    'frostedshell': ['Frosted Shell', 'pod', { 'newbucks': 200, 'saber': 10, 'fossil': 2 }, 'bluffs'],
    'glacialcrystal': ['Glacial Crystal', 'pod', { 'newbucks': 100, 'rock': 10, 'snowflake': 1 }, 'bluffs'],
    'snowzbench': ['SnowZ Bench', 'pod', { 'newbucks': 1000, 'saber': 25, 'cotton': 15, 'yolky': 5, 'fossil': 10, 'jelly': 5 }, 'bluffs'],
    'crystalspires': ['Crystal Spires', 'pod', { 'newbucks': 500, 'crystal': 10, 'snowflake': 1 }, 'bluffs'],
    'icecubed': ['Ice Cubed', 'pod', { 'newbucks': 100, 'puddle': 10, 'snowflake': 2 }, 'bluffs'],
    'icelamp': ['Ice Lamp', 'pod', { 'newbucks': 100, 'phosphor': 30, 'radiant': 3, 'snowflake': 2, 'sunsap': 1 }, 'bluffs'],
    'chillyslimestack': ['Chilly Slime Stack', 'pod', { 'newbucks': 800, 'saber': 25, 'rock': 10, 'snowflake': 3 }, 'bluffs'],
    'fireflower': ['Fire Flower', 'pod', { 'newbucks': 500, 'tangle': 15, 'wax': 5 }, 'bluffs'],
    'auroraflowers': ['Aurora Flowers', 'pod', { 'newbucks': 25, 'saber': 5 }, 'bluffs'],
    'aurorapine': ['Aurora Pine', 'pod', { 'newbucks': 5000, 'honey': 25, 'fossil': 10, 'wax': 10 }, 'bluffs'],
    'frozenflame': ['Frozen Flame', 'pod', { 'newbucks': 6000, 'puddle': 15, 'fire': 15, 'snowflake': 10, 'radiant': 10 }, 'bluffs'],
    'majesticsnowflake': ['Majestic Snowflake', 'pod', { 'newbucks': 8000, 'saber': 25, 'flutter': 25, 'snowflake': 10 }, 'bluffs'],
    'snowglobe': ['Snow Globe', 'pod', { 'newbucks': 15000, 'yolky': 20, 'boom': 25, 'fossil': 10 }, 'bluffs'],
    'conservatorybench': ['Conservatory Bench', 'pod', { 'newbucks': 100, 'pink': 10 }, 'conservatory'],
    'largesimplebench': ['Large Simple Bench', 'polestar', { 'newbucks': 500, 'boom': 10, 'cotton': 10, 'drift': 3 }, 'conservatory'],
    'conservatorychair': ['Conservatory Chair', 'viktor', { 'newbucks': 100, 'cotton': 10 }, 'conservatory'],
    'conservatorytable': ['Conservatory Table', 'viktor', { 'newbucks': 100, 'tabby': 10 }, 'conservatory'],
    'conservatorylamp': ['Conservatory Lamp', 'pod', { 'newbucks': 100, 'phosphor': 10, 'glass': 1 }, 'conservatory'],
    'smalltrellis': ['Small Trellis', 'polestar', { 'newbucks': 100, 'tabby': 5, 'brine': 5 }, 'conservatory'],
    'widetrellis': ['Wide Trellis', 'pod', { 'newbucks': 150, 'angler': 5, 'jelly': 3 }, 'conservatory'],
    'trellisarch': ['Trellis Arch', 'pod', { 'newbucks': 150, 'batty': 5, 'wildHoney': 3 }, 'conservatory'],
    'smallemeraldtrellis': ['Small Emerald Trellis', 'ogden', { 'newbucks': 100, 'cotton': 20, 'brine': 3, 'jelly': 2, 'wildHoney': 2 }, 'conservatory'],
    'wideemeraldtrellis': ['Wide Emerald Trellis', 'polestar', { 'newbucks': 200, 'tangle': 10, 'jelly': 3 }, 'conservatory'],
    'pottedplants': ['Potted Plants', 'pod', { 'newbucks': 250, 'honey': 10, 'brine': 5 }, 'conservatory'],
    'mushroomplanter': ['Mushroom Planter', 'pod', { 'newbucks': 100, 'tabby': 5, 'fossil': 3 }, 'conservatory'],
    'displaycase': ['Display Case', 'pod', { 'newbucks': 1500, 'crystal': 10, 'glass': 5 }, 'conservatory'],
    'wheelbarrow': ['Wheelbarrow', 'pod', { 'newbucks': 100, 'rock': 10, 'sand': 5 }, 'conservatory'],
    'goldenanglerstatue': ['Golden Angler Statue', 'pod', { 'newbucks': 15000, 'angler': 50, 'gold': 3, 'primordy': 10, 'diamond': 1 }, 'golden'],
    'goldenbattystatue': ['Golden Batty Statue', 'pod', { 'newbucks': 15000, 'batty': 50, 'gold': 3, 'jelly': 10, 'diamond': 1 }, 'golden'],
    'goldenchickenstatue': ['Golden Chicken Statue', 'pod', { 'newbucks': 15000, 'yolky': 20, 'gold': 3, 'fossil': 10, 'diamond': 1 }, 'golden'],
    'goldencottonstatue': ['Golden Cotton Statue', 'pod', { 'newbucks': 15000, 'cotton': 50, 'gold': 3, 'brine': 10, 'diamond': 1 }, 'golden'],
    'goldendervishstatue': ['Golden Dervish Statue', 'pod', { 'newbucks': 15000, 'dervish': 50, 'gold': 3, 'primordy': 10, 'diamond': 1 }, 'golden'],
    'goldenflutterstatue': ['Golden Flutter Statue', 'pod', { 'newbucks': 15000, 'flutter': 50, 'gold': 3, 'wax': 10, 'diamond': 1 }, 'golden'],
    'goldentabbystatue': ['Golden Tabby Statue', 'polestar', { 'newbucks': 10000, 'tabby': 50, 'gold': 3, 'wax': 10, 'diamond': 1 }, 'golden'],
    'goldentanglestatue': ['Golden Tangle Statue', 'pod', { 'newbucks': 15000, 'tangle': 50, 'gold': 3, 'jelly': 10, 'diamond': 1 }, 'golden'],
    'yellowreefbush': ['Yellow Reef Bush', 'polestar', { 'newbucks': 25, 'cotton': 5, 'brine': 1 }, 'beach'],
    'sunflowerumbrella': ['Sunflower Umbrella', 'polestar', { 'newbucks': 200, 'cotton': 5, 'honey': 5, 'wildHoney': 1 }, 'beach'],
    'sakuraumbrella': ['Sakura Umbrella', 'polestar', { 'newbucks': 200, 'cotton': 5, 'pink': 5, 'wax': 1 }, 'beach'],
    'beachumbrella': ['Beach Umbrella', 'pod', { 'newbucks': 200, 'cotton': 20, 'pink': 5, 'sand': 1 }, 'beach'],
    'stripedbeachblanket': ['Striped Beach Blanket', 'polestar', { 'newbucks': 150, 'cotton': 10, 'jelly': 3 }, 'beach'],
    'beachlantern': ['Beach Lantern', 'pod', { 'newbucks': 200, 'angler': 5, 'lava': 3 }, 'beach'],
    'seashells': ['Seashells', 'polestar', { 'newbucks': 25, 'tabby': 5, 'primordy': 1 }, 'beach'],
    'seashellcollection': ['Seashell Collection', 'polestar', { 'newbucks': 25, 'cotton': 5, 'radiant': 1 }, 'beach'],
    'seagrass': ['Seagrass', 'polestar', { 'newbucks': 25, 'tabby': 5, 'brine': 1 }, 'beach'],
    'seaweed': ['Seaweed', 'polestar', { 'newbucks': 25, 'pink': 5, 'jelly': 1 }, 'beach'],
    'curlyseaweed': ['Curly Seaweed', 'polestar', { 'newbucks': 25, 'phosphor': 5, 'fossil': 1 }, 'beach'],
    'blueswirltree': ['Blue Swirl Tree', 'polestar', { 'newbucks': 50, 'boom': 10, 'radiant': 1 }, 'beach'],
    'pinkreefbush': ['Pink Reef Bush', 'polestar', { 'newbucks': 50, 'fire': 5, 'fossil': 1 }, 'beach'],
    'pinkreeftree': ['Pink Reef Tree', 'polestar', { 'newbucks': 50, 'angler': 10, 'primordy': 1 }, 'beach'],
    'pinkreeftreecluster': ['Pink Reef Tree Cluster', 'polestar', { 'newbucks': 50, 'cotton': 10, 'fossil': 1 }, 'beach'],
    'tallpinkreeftree': ['Tall Pink Reef Tree', 'polestar', { 'newbucks': 50, 'tabby': 10, 'glass': 1 }, 'beach'],
    'bluereefbush': ['Blue Reef Bush', 'polestar', { 'newbucks': 50, 'saber': 10, 'jelly': 1 }, 'beach'],
    'blueanemone': ['Blue Anemone', 'polestar', { 'newbucks': 25, 'phosphor': 5, 'wax': 1 }, 'beach'],
    'pinkanemone': ['Pink Anemone', 'polestar', { 'newbucks': 25, 'pink': 5, 'jelly': 1 }, 'beach'],
    'pinkanemonecluster': ['Pink Anemone Cluster', 'polestar', { 'newbucks': 25, 'tabby': 5, 'radiant': 1 }, 'beach'],
    'shortpinkflowerreef': ['Short Pink Flower Reef', 'polestar', { 'newbucks': 50, 'dervish': 10, 'jelly': 1 }, 'beach'],
    'pinkflowerreef': ['Pink Flower Reef', 'polestar', { 'newbucks': 50, 'honey': 10, 'wax': 1 }, 'beach'],
    'tallpinkflowerreef': ['Tall Pink Flower Reef', 'polestar', { 'newbucks': 50, 'tangle': 10, 'snowflake': 1 }, 'beach'],
    'clamthrone': ['Clam Throne', 'polestar', { 'newbucks': 500, 'angler': 10, 'honey': 10, 'brine': 3 }, 'beach'],
    'smallsandcastle': ['Small Sand Castle', 'polestar', { 'newbucks': 500, 'fire': 10, 'flutter': 10, 'wildHoney': 3 }, 'beach'],
    'largesandcastle': ['Large Sand Castle', 'polestar', { 'newbucks': 500, 'puddle': 10, 'honey': 10, 'sand': 3 }, 'beach'],
    'reefchair': ['Reef Chair', 'polestar', { 'newbucks': 200, 'puddle': 5, 'fossil': 5 }, 'beach'],
    'reeftable': ['Reef Table', 'polestar', { 'newbucks': 200, 'angler': 10, 'brine': 5 }, 'beach'],
    'smallnet': ['Small Net', 'polestar', { 'newbucks': 400, 'cotton': 10, 'wildHoney': 3 }, 'beach'],
    'mediumnet': ['Medium Net', 'polestar', { 'newbucks': 500, 'puddle': 10, 'sand': 3 }, 'beach'],
    ...
    'slimejailstandee': ['Slime Jail Standee', 'polestar', { 'newbucks': 500, 'ringtail': 10, 'tabby': 5, 'lava': 3 }, 'fun'],
    'sunflowerstandee': ['Sunflower Standee', 'polestar', { 'newbucks': 500, 'tangle': 10, 'puddle': 5, 'radiant': 3 }, 'fun'],
    'snowmanstandee': ['Snowman Standee', 'polestar', { 'newbucks': 500, 'saber': 10, 'cotton': 5, 'snowflake': 3 }, 'fun'],
...
export const decorationsDescription: { [key: string]: string } = {
    ...
    'mediumpinkcoralcolumns': "Once populated by other aquatic life, these columns are often found where angler slimes abound.",
    ...
    'auroraflowers': "While not truly auroras, these ethereal flowers capture the majestic, prismatic splendor of the night sky.",
    'aurorapine': "While not truly an aurora, this ethereal pine tree evokes the wonder of the night sky even during the day.",
    'frozenflame': "Prismatic energy captured in ice the shape of a dancing flame lights up the night surely as any fire.",
    'majesticsnowflake': "It's not perfect, but this massive snowflake adds a touch of serenity and grace anywhere it's placed.",
    'snowglobe': "A decorative globe that plays a hauntingly beautiful melody reminiscent of a moonlit dance during a snowy night.",
    'conservatorybench': "A bench that invites one to just relax and take in the view. Even the energetic slimes enjoy taking a break on a bench now and then.",
    'largesimplebench': "An inviting bench, where slimes can relax together and take a breath.",
    'conservatorychair': "If slimes had legs they'd love to kick back and relax on one of these comfy chairs. For now, they can only dream...",
    'conservatorytable': "A simple round table that is clearly part of a furniture set. Chairs sold separately, because that's how they get you.",
    'conservatorylamp': "These self-powered lamps use mysterious, advanced technology so their bulbs never need to be changed.",
    'smalltrellis': "This small trellis wall is a great way to add structure to a garden when space is at a premium or you're just a big fan of small trellises.",
    'widetrellis': "This trellis wall is a great way to add structure to a garden, though some might say a garden should have no such thing.",
    ...
    'wideemeraldtrellis': "A large trellis with lovely ivy growing over it. Perfect for adding a bit of structure to a garden.",
    ...
    'displaycase': "Show off your prized collection of items with this handy display case. Perfectly preserving objects for your viewing pleasure!",
    'wheelbarrow': "Despite vacpack technology making many manual hauling devices obsolete, wheelbarrows persisted for their advanced ability to get in one and go weeeeeeee.",
    'goldenanglerstatue': "Dazzle onlookers with this golden monument to Rainbow Island's most flashy slime.",
    'goldenbattystatue': "This shining monument to Rainbow Island's nocturnal hunters will bring a sparkle to even the darkest cave.",
    ...
    'goldendervishstatue': "Celebrate Dervish Slimes with this shiny, gold statue that importantly, remains perfectly still all the time, and doesn't create hazardous cyclones. If it ever does: full refund.",
    ...
    'goldentanglestatue': "A golden monument to the tenacious Tangle slime, which makes a great garden centerpiece when you'd rather not deal with Tangle Slimes.",
    ...
    'beachlantern': "A hanging lantern in the shape of a beach ball, yet it is not a beach ball, but instead a hanging lantern. So, very clever of this beach ball I mean lantern.",
    ...
    'blueswirltree': "These trees unfurl to enormous sizes in the depths of the slime sea, but swirl playfully when transplanted to the shore.",
    'pinkreefbush': "This hardly little reef bush resembles a mass of pink worms, but is only occasionally an actual mass of worms.",
    ...
    'largesandcastle': "A day at the beach isn't complete without building a sand castle. This one stands proud and imposing. Just don't step on it!",
    ...
    'daintyteacup': "This delicate teacup perfectly fits slimes, who are so eager to hop inside that it's never practical to fill it with tea.",
    'bountifulteacup': "This large teacup might be overflowing with tea if largos weren't always trying to take turns hopping inside of it.",
    'pinkstripedlamp': "This bright and playful lamp is guaranteed to lend a touch of whimsical brilliance anywhere it's used.",
    ...
    'seesaw': "A great way for slimes to make friends, and help each other through all the ups and downs of life on the ranch.",
    'carousel': "...riding a carousel around and around is a wonderful way for slimes to have fun because going in circles is always fun, just like how...",
