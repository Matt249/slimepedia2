...
export const regionsResourcesInfos: { [key: string]: [string, string, string] } = {
    'gordoPink': ['Pink Gordo', 'gordos/pink', '/slimes/pink'],
    'gordoCotton': ['Cotton Gordo', 'gordos/cotton', '/slimes/cotton'],
    'gordoPhosphor': ['Phosphor Gordo', 'gordos/phosphor', '/slimes/phosphor'],
    'gordoHunter': ['Hunter Gordo', 'gordos/hunter', '/slimes/hunter'],
    'gordoHoney': ['Honey Gordo', 'gordos/honey', '/slimes/honey'],
    'gordoRingtail': ['Ringtail Gordo', 'gordos/ringtail', '/slimes/ringtail'],
    'gordoAngler': ['Angler Gordo', 'gordos/angler', '/slimes/angler'],
    'gordoFlutter': ['Flutter Gordo', 'gordos/flutter', '/slimes/flutter'],
    'gordoBatty': ['Batty Gordo', 'gordos/batty', '/slimes/batty'],
    'gordoBoom': ['Boom Gordo', 'gordos/boom', '/slimes/boom'],
    'gordoCrystal': ['Crystal Gordo', 'gordos/crystal', '/slimes/crystal'],
    'gordoRock': ['Rock Gordo', 'gordos/rock', '/slimes/rock'],
    'gordoTabby': ['Tabby Gordo', 'gordos/tabby', '/slimes/tabby'],
    'gordoSaber': ['Saber Gordo', 'gordos/saber', '/slimes/saber'],
    'gordoTwin': ['Twin Gordo', 'gordos/twin', '/slimes/twin'],
    'gordoSloomber': ['Sloomber Gordo', 'gordos/sloomber', '/slimes/sloomber'],
