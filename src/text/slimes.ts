...
export const slimesList: { [key: string]: [string, string, string, boolean, string[], string] } = {
    'pink': ['Pink Slime', 'food', 'none', true, ['rf', 'ss', 'ev', 'pb', 'gl'], 'ball'],
    'cotton': ['Cotton Slime', 'veggies', 'lettuce', true, ['rf', 'ss', 'pb', 'gl'], 'bouncy'],
    'tabby': ['Tabby Slime', 'meat', 'henStony', true, ['rf', 'ss', 'ev', 'gl'], 'yarn'],
    'phosphor': ['Phosphor Slime', 'fruits', 'cuberry', true, ['rf', 'ss', 'ev', 'pb', 'gl'], 'none'],
    'rock': ['Rock Slime', 'veggies', 'beet', true, ['ss', 'ev', 'pb', 'gl'], 'none'],
    'hunter': ['Hunter Slime', 'meat', 'rooster', true, ['ss', 'pb', 'gl'], 'none'],
    'angler': ['Angler Slime', 'meat', 'henSea', true, ['ss', 'ev', 'gl'], 'puffer'],
    'puddle': ['Puddle Slime', 'water', 'water', false, ['ss', 'ev', 'pb', 'gl'], 'duck'],
    'ringtail': ['Ringtail Slime', 'food', 'none', true, ['ss', 'ev', 'pb', 'gl'], 'trash'],
    'honey': ['Honey Slime', 'fruits', 'mango', true, ['ss', 'gl'], 'none'],
    'flutter': ['Flutter Slime', 'nectar', 'nectar', true, ['ss'], 'worm'],
    'batty': ['Batty Slime', 'fruits', 'granite', true, ['ev', 'gl'], 'moon'],
    'boom': ['Boom Slime', 'meat', 'henBriar', true, ['ev', 'pb', 'gl'], 'bomb'],
    'crystal': ['Crystal Slime', 'veggies', 'onion', true, ['ev', 'pb', 'gl'], 'none'],
    'fire': ['Fire Slime', 'ash', 'ash', false, ['ev', 'gl'], 'none'],
    'saber': ['Saber Slime', 'meat', 'henCluck', true, ['pb'], 'none'],
    'shadow': ['Shadow Slime', 'none', 'none', false, ['gl'], 'none'],
    'twin': ['Twin Slime', 'fruits', 'cherry', true, ['gl'], 'none'],
...
export const slimesText: { [key: string]: string } = {
    ...
    'phosphor': 'The softly glowing heralds of starlight.',
    'rock': 'These slimes ore totally metal.',
    'honey': 'Nothing is sweeter than (a freshly produced plort of) honey.',
    'flutter': 'Like snowflakes, each pair of wings are unique, and just as delicate.',
    'hunter': 'Nevermind the rabbit, have you seen any chickens?',
    'ringtail': 'Where there\'s a crime, there\'s a ringtail slime.',
    'puddle': 'Keep one in your boot and you\'ll always stay cool. But it\'s weird.',
    'angler': 'So pretty! Let me just get a closer-',
    'batty': 'A fiendish stalker of the night, hungering always... for fruit.',
    'boom': 'Careful, these slimes have been known to expl-',
    'crystal': 'It\'s clear as shiny, transparent rocks that these slimes are dangerous.',
    'fire': 'Like a little campfire, except that it moves and it\'s a slime.',
    'saber': 'A bouncing blast from the past.',
    'shadow': 'Chase your shadow and it will flee.',
    'twin': 'Know thyself, and thy other self as well.',
    'sloomber': 'To sleep-perchance to... sleep more, and more, and more.',
    'yolky': 'This slime always looks at the sunny side... up.',
    'tangle': 'A rose by any other name would still eat a chicken.',
    'dervish': 'Twists and turns all day and spirals all night.',
    'lucky': 'Oooh, shiny!',
