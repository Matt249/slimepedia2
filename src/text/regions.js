...
export const regionsResourcesInfos = {
    ...
    'dark': ['Always Dark', 'buildings/shield', []],
    'spawnHen': ['Hen Hen Spawn', 'food/hen', ['food', 'meat', 'hen']],
    'spawnRooster': ['Rooster Spawn', 'food/rooster', ['food', 'meat', 'rooster']],
    'spawnPogo': ['Pogofruit Trees', 'food/pogo', ['food', 'fruit', 'pogo']],
    'spawnCarrot': ['Carrot Patches', 'food/carrot', ['food', 'veggies', 'carrot']],
    'pond': ['Natural Ponds', 'buildings/pond', ['food', 'special', 'water']],
    'jumppad': ['Jump Pad', 'slimes/rad', []]
}